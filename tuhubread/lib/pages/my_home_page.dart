                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: user.avatarUrl.isEmpty
                            ? const Icon(Icons.person_rounded, size: 50, color: Color(0xFFD35400))
                            : null,
                      ),
                      ...
                      Text(
                        user.phoneNumber.isNotEmpty ? user.phoneNumber : 'Chưa cập nhật SĐT',
                        style: const TextStyle(fontSize: 16, color: Color(0xFF7F8C8D)),
                      ),
                      const SizedBox(height: 4),
                      Text(
                        '${l10n.roleLabel}${user.role}',
                        style: const TextStyle(fontSize: 14, color: Color(0xFF95A5A6), fontWeight: FontWeight.bold),
                      ),
                      ...
                      ElevatedButton.icon(
                        ...
                        icon: const Icon(Icons.logout_rounded, color: Colors.white),
                        label: Text(l10n.logoutButton, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
